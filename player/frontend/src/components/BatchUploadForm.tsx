...
function computeDimensions(typeId: number, canon: Record<string, unknown>): { w?: number; h?: number } {
  ...
  if ((typeId === 3 || typeId === 4 || typeId === 5 || typeId === 7 || typeId === 8 || typeId === 9 || typeId === 10 || typeId === 11 || typeId === 12 || typeId === 13 || typeId === 14 || typeId === 16 || typeId === 17 || typeId === 18 || typeId === 22) && canon.cells) {
