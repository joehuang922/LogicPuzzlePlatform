    ...
    <div style={{ border: "2px solid #4a90d9", borderRadius: 8, padding: "1rem", background: "#f8fbff" }}>
      ...
      <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
        ...
        <div style={{ flex: 1, minWidth: 250, display: "flex", flexDirection: "column" }}>
          ...
          <textarea
            style={{ flex: 1, minHeight: 300, fontFamily: "monospace", fontSize: "0.75rem", padding: "0.5rem", border: "1px solid #ccc", borderRadius: 4, resize: "vertical" }}
            value={jsonText}
            onChange={(e) => setJsonText(e.target.value)}
          />
        </div>
      ...
      <div style={{ marginTop: "1rem", display: "flex", gap: "0.5rem" }}>
        <button onClick={() => onComplete(jsonText)}
