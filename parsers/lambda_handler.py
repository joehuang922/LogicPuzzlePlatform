...
def _init_parsers():
    ...
    _parsers = {
        ...
        12: KakuroParser(),
        13: YajilinParser(),
        14: FillominoParser(ocr_backend=_ocr),
        15: LitsParser(),
