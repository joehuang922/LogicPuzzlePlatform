"""CLI entry point: python -m puzzle_parsers.norinori <image> [-o output.json]"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Parse a Norinori puzzle image into JSON"
    )
    ...
    norinori_parser = NorinoriParser()
    board = norinori_parser.parse_file(image_path, debug_dir=args.debug)
