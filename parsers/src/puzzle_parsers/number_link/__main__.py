"""CLI entry point: python -m puzzle_parsers.number_link <image> [-o output.json]"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Parse a number-link puzzle image into JSON"
    )
    ...
    number_link_parser = NumberLinkParser(ocr_backend=ocr_backend)
    board = number_link_parser.parse_file(image_path, debug_dir=args.debug)
