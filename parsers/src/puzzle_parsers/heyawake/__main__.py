"""CLI entry point: python -m puzzle_parsers.heyawake <image> [-o output.json]"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Parse a heyawake puzzle image into JSON"
    )
    ...
    heyawake_parser = HeyawakeParser()
    board = heyawake_parser.parse_file(image_path, debug_dir=args.debug)
