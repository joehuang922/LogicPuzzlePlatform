"""CLI entry point: python -m puzzle_parsers.masyu <image> [-o output.json]"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Parse a masyu puzzle image into JSON"
    )
    ...
    parser.add_argument(
        ...
        choices=["gemini", "none"],
        default="gemini",
        help="OCR backend for circle recognition (default: gemini)",
    )
