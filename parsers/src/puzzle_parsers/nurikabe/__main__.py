"""CLI entry point: python -m puzzle_parsers.nurikabe <image> [-o output.json]"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Parse a nurikabe puzzle image into JSON"
    )
    ...
    nurikabe_parser = NurikabeParser(ocr_backend=ocr_backend)
    board = nurikabe_parser.parse_file(image_path, debug_dir=args.debug)
