"""CLI entry point: python -m puzzle_parsers.lits <image> [-o output.json]"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Parse a LITS puzzle image into JSON"
    )
    ...
    lits_parser = LitsParser()
    board = lits_parser.parse_file(image_path, debug_dir=args.debug)
