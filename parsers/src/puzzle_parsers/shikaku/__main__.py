"""CLI entry point: python -m puzzle_parsers.shikaku <image> [-o output.json]"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Parse a shikaku puzzle image into JSON"
    )
    ...
    shikaku_parser = ShikakuParser()
    board = shikaku_parser.parse_file(image_path, debug_dir=args.debug)
