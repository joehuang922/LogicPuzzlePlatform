"""CLI entry point: python -m puzzle_parsers.yajilin <image> [-o output.json]"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Parse a yajilin puzzle image into JSON"
    )
    ...
    yajilin_parser = YajilinParser()
    board = yajilin_parser.parse_file(image_path, debug_dir=args.debug)
