"""CLI entry point: python -m puzzle_parsers.kakuro <image> [-o output.json]"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Parse a kakuro puzzle image into JSON"
    )
    ...
    kakuro_parser = KakuroParser()
    board = kakuro_parser.parse_file(image_path, debug_dir=args.debug)
