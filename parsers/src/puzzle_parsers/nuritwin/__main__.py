"""CLI entry point: python -m puzzle_parsers.nuritwin <image> [-o output.json]"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Parse a nuritwin puzzle image into JSON"
    )
    ...
    nuritwin_parser = NuritwinParser()
    board = nuritwin_parser.parse_file(image_path, debug_dir=args.debug)
