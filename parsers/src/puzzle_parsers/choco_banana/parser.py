...
from puzzle_parsers.choco_banana.grid_detector import detect_choco_banana_grid
from puzzle_parsers.choco_banana.models import ChocoBananaBoard

if TYPE_CHECKING:
    from puzzle_parsers.recognition import OcrBackend


class ChocoBananaParser(PuzzleParser):
    puzzle_type = "choco_banana"
    ...
    def _parse_image(
        ...
        geom = detect_choco_banana_grid(img_array, debug_dir=debug_dir)
    ...
    def to_json(self, board: ChocoBananaBoard, output_path: str | Path) -> None:
