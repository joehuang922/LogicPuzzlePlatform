"""CLI entry point: python -m puzzle_parsers.choco_banana <image> [-o output.json]"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Parse a choco-banana puzzle image into JSON"
    )
    ...
    choco_banana_parser = ChocoBananaParser(ocr_backend=ocr_backend)
    board = choco_banana_parser.parse_file(image_path, debug_dir=args.debug)
