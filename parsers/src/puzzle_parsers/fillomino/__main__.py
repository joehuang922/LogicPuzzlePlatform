"""CLI entry point: python -m puzzle_parsers.fillomino <image> [-o output.json]"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Parse a fillomino puzzle image into JSON"
    )
    ...
    fillomino_parser = FillominoParser(ocr_backend=ocr_backend)
    board = fillomino_parser.parse_file(image_path, debug_dir=args.debug)
